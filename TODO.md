...
- [x] **Social login** — Google sign-in only. Apple sign-in was added 2026-09-04 then removed the same day: it needs a paid Apple Developer Program membership ($99/yr) just to configure, which isn't worth it for this app. Free alternatives worth considering later: Microsoft/Outlook and GitHub (both free OAuth providers in Firebase, just need a free app registration), and phone-number sign-in (free within Firebase's monthly SMS quota, metered after). Facebook/Instagram or any other Meta login is explicitly out — not adding social-media-account logins.
