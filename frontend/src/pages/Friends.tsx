        ...
        <div className="max-w-xl mx-auto space-y-4">
          ...
          {isLoading ? (
            ...
            <motion.div
              ...
              className="rounded-2xl border border-white/10 bg-white/[0.04] p-8 text-center space-y-3"
            >
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex flex-wrap gap-1.5 mt-2.5 pl-10">
                      <span className="px-2 py-0.5 rounded-full bg-white/8 border border-white/10 text-[10px] font-bold text-white/60">
                      ...
                      <span className={`px-2 py-0.5 rounded-full border text-[10px] font-bold ${
                        f.fastedToday
                          ...
                          : 'bg-white/8 border-white/10 text-white/35'
                      }`}>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.04] overflow-hidden">
            ...
            <AnimatePresence>
              {howOpen && (
                ...
                >
                  <div className="px-4 pb-4 pt-1 space-y-1.5 text-xs text-white/45 border-t border-white/5">
                    <p>
