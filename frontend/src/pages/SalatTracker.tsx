...
export default function SalatTracker() {
  ...
  const isPrayerCompleted = (prayerId: string) => completedPrayers.includes(prayerId);
    ...
    <AnimatedBackground variant="dark">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 sm:py-12">
        ...
        >
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-3">Salat Tracker</h1>
          <p className="text-lg sm:text-xl text-white/80">Track your five daily prayers</p>
        </motion.div>
          ...
          <div className="inline-block relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center">
                <div className="text-4xl sm:text-5xl font-bold text-white">{completedPrayers.length}</div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
          {prayers.map((prayer, index) => (
            <motion.button
              ...
              className={`card ${
                isPrayerCompleted(prayer.id) ? 'bg-white text-indigo-600 shadow-2xl' : 'bg-white/10 text-white border-2 border-white/30'
          ...
          {completedPrayers.length === 5 && (
            ...
            >
              <div className="bg-white shadow-2xl rounded-3xl p-6 flex items-center gap-4 border-4 border-green-500">
                ...
                <div>
                  <h3 className="font-bold text-lg text-indigo-600">Masha'Allah!</h3>
                  <p className="text-sm text-gray-600">All prayers completed!</p>
                </div>
              </div>
            </motion.div>
          )}
