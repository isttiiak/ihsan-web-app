      ...
      <div className="p-4 sm:p-6 lg:p-8">
        <div className="max-w-2xl mx-auto space-y-5 pb-10">
          ...
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.08 }}
            ...
            <p className="text-brand-emerald font-black text-sm uppercase tracking-widest">{t('about.intentionLabel')}</p>
            <p className="text-white/60 text-sm leading-relaxed">
              {t('about.intentionText')}
            </p>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}
            ...
            <p className="text-brand-gold font-black text-sm uppercase tracking-widest">📖 {t('about.authenticityLabel')}</p>
            <p className="text-white/60 text-sm leading-relaxed">
              {t('about.authenticityText1')}{' '}
              <a href="https://quran.com" target="_blank" rel="noopener noreferrer" className="text-brand-emerald underline">quran.com</a> {t('about.authenticityOr')}{' '}
