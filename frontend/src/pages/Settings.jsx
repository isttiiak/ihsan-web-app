...
export default function Settings() {
  ...
  const { reduceMotion, highContrast, setReduceMotion, setHighContrast } =
    useUiStore();
          ...
          >
            <div className="card-body p-6 sm:p-8">
              ...
              <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                <label className="label cursor-pointer justify-start gap-4 p-3 rounded-xl border border-base-300/40 bg-base-100/60 backdrop-blur supports-[backdrop-filter]:bg-base-100/50">
                  <input
                    type="checkbox"
                  ...
                  <div>
                    ...
                    <div className="label-text-alt text-xs opacity-70">
                      Respect motion sensitivity and tone down effects
                    </div>
                  </div>
                </label>
                ...
                <label className="label cursor-pointer justify-start gap-4 p-3 rounded-xl border border-base-300/40 bg-base-100/60 backdrop-blur supports-[backdrop-filter]:bg-base-100/50">
                  ...
                  <div>
                    ...
                    <div className="label-text-alt text-xs opacity-70">
                      Stronger text and focus outlines for clarity
                    </div>
                  </div>
                </label>
              </div>
