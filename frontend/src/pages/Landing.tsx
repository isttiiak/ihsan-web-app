      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 pb-20">
        ...
        <section className="text-center pt-14 sm:pt-20 pb-10">
          ...
          >
            ...
            <button
              className="btn h-13 px-6 rounded-2xl bg-white/5 border-white/15 text-white/80 font-bold"
        ...
        <motion.section {...fadeUp} className="mb-12">
          <div className="rounded-3xl border border-white/10 bg-brand-deep/70 p-6 sm:p-8 text-center">
        ...
        <motion.section {...fadeUp} className="text-center pb-4">
          ...
          <div className="flex flex-wrap justify-center gap-3 mt-7">
            ...
            <Link to="/about" className="btn h-13 px-6 rounded-2xl bg-white/5 border-white/15 text-white/70 font-bold">
              Read our story
            </Link>
          </div>
        </motion.section>
