...
export const NAFL_TYPE_META: NaflTypeMeta[] = [
  ...
  },
  {
    ...
    arabic: 'الضحى',
    emoji: '☀️',
    shortNote: 'Mid-morning, 2–12 rak\'ahs',
    fullNote: 'Prayed after Ishraq through mid-morning. "The Prophet ﷺ used to pray Duha four rak\'ahs and would add more as Allah willed."',
