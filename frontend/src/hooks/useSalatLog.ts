...
export const NAFL_TYPE_META: NaflTypeMeta[] = [
  ...
  },
  {
    ...
    fullNoteBn: '"যে ব্যক্তি জামাতে ফজর পড়ে, সূর্যোদয় পর্যন্ত আল্লাহর যিকিরে বসে থাকে, তারপর দুই রাকাত পড়ে — তার জন্য হজ্জ ও উমরার পূর্ণ, পূর্ণ, পূর্ণ সওয়াব।"',
    hadith: 'Tirmidhī 586',
  ...
  },
  {
    ...
    fullNoteBn: 'সর্বনিম্ন ২ রাকাত; হানাফী মাযহাবে ৪ রাকাত উত্তম। "নবী ﷺ চাশতের নামায চার রাকাত পড়তেন এবং আল্লাহ যতটা চাইতেন ততটা বাড়াতেন।" সর্বোচ্চ ১২ রাকাত।',
  ...
  },
  {
    ...
    fullNoteBn: 'মাগরিব ও এশার মধ্যবর্তী সময়ে পড়া হয়। যারা বারবার আল্লাহর দিকে ফিরে আসে (আউয়াব) তাদের জন্য।',
  ...
  },
  {
    ...
    fullNoteBn: 'অত্যন্ত গুরুত্বপূর্ণ (হানাফী মাযহাবে ওয়াজিব)। এশার পর, ফজরের আগে পড়া হয়। সাধারণত কুনূত দু\'আসহ ৩ রাকাত।',
  ...
  },
  {
    ...
    fullNoteBn: 'বিলাল (রা)-কে জান্নাতে তাঁর আমল সম্পর্কে জিজ্ঞাসা করা হয়েছিল। তিনি বলেছিলেন: "আমি এছাড়া আর কিছু করি না যে, যখনই ওযু করি, দুই রাকাত নামায পড়ি।"',
  ...
  },
  {
    ...
    fullNoteBn: '"তোমাদের কেউ মসজিদে প্রবেশ করলে দুই রাকাত নামায না পড়া পর্যন্ত যেন না বসে।" নামায না পড়ে বসবেন না।',
  ...
  },
  {
    ...
    fullNoteBn: '"যার আল্লাহর কাছে অথবা কোনো মানুষের কাছে কোনো প্রয়োজন আছে, সে যেন ওযু করে, দুই রাকাত নামায পড়ে, তারপর আল্লাহর প্রশংসা করে, নবী ﷺ-এর প্রতি দরুদ পাঠ করে, তারপর দু\'আ করে।"',
  ...
  },
  {
    ...
    fullNoteBn: '"নবী ﷺ আমাদের সকল বিষয়ে ইস্তিখারা শেখাতেন, যেমন তিনি কুরআনের একটি সূরা শেখাতেন।" দুই রাকাত নামায পড়ে ইস্তিখারার দু\'আ পড়ুন।',
  ...
  },
  {
    ...
    fullNoteBn: 'রমজানে এশার পর ৮ অথবা ২০ রাকাত। "যে ব্যক্তি ঈমানসহ ও সওয়াবের আশায় রমজানে নামায পড়ে, তার অতীতের গুনাহ ক্ষমা করে দেওয়া হয়।"',
